...
class MusicPlayer:
    ...
    def __init__(self, root):
        ...
        self.bg_image =  tk.PhotoImage(file = os.path.join(os.getcwd(), "E:\Python Practice\Music App\Music Player\music", "bg_con.png"))
        ...
        s = ttk.Style()
        s.configure('TButton', font=('Arial', 12), background='lightblue', foreground='black', padding=10, relief='raised')
        s.map('TButton', background=[('active', 'lightgreen')])
        ...
        self.bg_image3 =  tk.PhotoImage(file = os.path.join(os.getcwd(), "E:\Python Practice\Music App\Music Player\music", "control_bg.png"))
